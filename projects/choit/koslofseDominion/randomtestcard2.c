/*******************************************************************************
** Title: Assignment 4 - randomtestcard2.c
** Author: Titus Choi
...
**                 card.
**              6. Verify the coin count after usage of the "Council Room" card.
**              7. Verify the "Council Room" card supply after usage.
**
...
int main() {
    ...
    while (testCounter < MAX_TEST) {
        ...
        // Test 7: Verify Council Room Supply Count
        if (G.supplyCount[council_room] != testG.supplyCount[council_room]) {
            testSevenFailed++;
        }
