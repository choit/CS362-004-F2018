/*******************************************************************************
** Title: Assignment 4 - randomtestadventurer.c
** Author: Titus Choi
...
**              7. Verify the "Adventurer" card supply after usage.
**
...
int main() {
    ...
    while (testCounter < MAX_TEST) {
        ...
        cardEffect(adventurer, choice1, choice2, choice3, &testG, handpos,
                   &bonus);
        ...
        // Test 7: Verify Adventurer Supply Count
        if (G.supplyCount[adventurer] != testG.supplyCount[adventurer]) {
            testSevenFailed++;
        }
